...
while True:
    ...
    while True:
        ...
        #if guess < 1 or guess > 100:                                           # rather than this, let's make program robust so does not crash w alpha input
            #print("You must limit your choices to between 1 and 100""""     # could do something like this but discuss action if outside range w Andy
